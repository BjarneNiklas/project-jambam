# Masterthesis: Gamifizierte KI-gestützte Spielideation
...
#### **F2: Game Design Trends & Interaktive Medien**
...
### **3.1 Multi-Agenten-System Design**
...
#### **Jam Kits (Implementierbare Konzepte)**
```dart
class MediaJamKit {
  String title;
  String description;
